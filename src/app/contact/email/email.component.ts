...
const SELECTOR = "email-component";
export class EmailComponent extends HTMLElement {
  ...
  constructor() {
    ...
    this.setAttribute(EmailComponent.styleId, "");
    ...
    EmailComponent.appendScopedStyle(scopedCssString);
      ...
      (match, selector) => {
        ...
        const scopedSelector = selector
          ...
          .map((part) => {
            ...
            return `${part.trim()}[${EmailComponent.styleId}] `;
          })
          .join(", ");
  ...
  scopeHtml(html) {
    ...
    doc.body.querySelectorAll("*").forEach((el) => {
      ...
      if (!el.tagName.includes("-")) {
        ...
        el.setAttribute(EmailComponent.styleId, "");
      }
    });
...
if (!customElements.get(SELECTOR)) {
  customElements.define(SELECTOR, EmailComponent);
}
